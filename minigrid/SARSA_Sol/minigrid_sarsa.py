...
def SARSA_control(env,q_values,P,epi,terminal,nA,max_steps,gamma=0.9,alpha=0.15):
    eps=1.0
    steps=[]
    total_reward=[]
...
initial=time.time()
q_values,P,steps,total_reward = SARSA_control(env,q_values,P,epi,terminal,nA,max_steps,gamma=0.9,alpha=0.215) 
final=time.time()
